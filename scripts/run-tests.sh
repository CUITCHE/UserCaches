...
if [[ "$TRAVIS_OS_NAME" == "linux" ]]; then
	...
	wget https://swift.org/builds/swift-4.1.2-release/ubuntu1404/${SWIFT_VERSION}/${SWIFT_VERSION}-ubuntu14.04.tar.gz
	...
	curl -O https://swift.org/builds/swift-4.1.2-release/xcode/${SWIFT_VERSION}/${SWIFT_VERSION}-osx.pkg

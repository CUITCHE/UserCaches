#
#  Be sure to run `pod spec lint UserCache.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "hejunqiu"
  # s.authors            = { "hejunqiu" => "xiaohe918@vip.qq.com" }
  # s.social_media_url   = "http://twitter.com/hejunqiu"
  ...
  s.source       = { :git => "https://github.com/CUITCHE/UserCaches.git", :tag => "#{s.version}" }
